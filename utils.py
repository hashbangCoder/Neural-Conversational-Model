...
def getWordList(filePath='../../Conversational Data/cornell movie-dialogs corpus/movie_lines.txt'):
...
def saveDataAsRecord(wordToIndDict = '../WordVecFiles/wordToIndex.dict',filePath = '../../Conversational Data/cornell movie-dialogs corpus/'):
	data,wordList = getWordList(filePath = filePath+'movie_lines.txt')
