...
print('The chatbot is now online and you can start interacting...\n')
inp = raw_input('You:  ')
...
init_op.run()
#seqToseq/dec/RNN/GRUCell/Candidate/Linear/Bias
...
saver.restore(sess,'../Checkpoints/checkpoint_48000')
